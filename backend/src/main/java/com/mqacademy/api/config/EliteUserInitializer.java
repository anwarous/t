...
public class EliteUserInitializer implements CommandLineRunner {
    ...
    private static final String ELITE_EMAIL = "elite.user@mqacademy.dev";
    ...
    public void run(String... args) {
        User elite = userRepository.findByEmail(ELITE_EMAIL)
                .orElseGet(() -> User.builder().email(ELITE_EMAIL).build());
